...
export default function HybridResultsPage({ jobId, fileName, events, ruleEvents, edits, audit, editAiEvent, clinician, onBackDashboard, onOpenRecordings, onGoToReport, onOpenAnalysisPage }) {
